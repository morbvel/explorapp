...
class ap_ProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'explorapp', 'user' => 'Miguel', 'password' => 123456, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/explorapp/PCBundle/Entity'))), 'explorapp\\PCBundle\\Entity');
        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('PCBundle' => 'explorapp\\PCBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_cfb29473ca15837a6e7bffcc9810dcd97ad541751edbafc89866353033fab5f5');
        return $instance;
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/explorapp/PCBundle/Resources/views'), 'PC');
        $instance->addPath(($this->targetDirs[3].'/src/explorapp/MobileBundle/Resources/views'), 'Mobile');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a660403b89b91a69a1068d152bf4205a9dd8dcce');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('55f714ca4a9883.63834210')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PCBundle' => 'explorapp\\PCBundle\\PCBundle',
                'MobileBundle' => 'explorapp\\MobileBundle\\MobileBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'ap_ProdProjectContainer',
            'database_host' => '127.0.0.1',
            'database_port' => 3306,
            'database_name' => 'explorapp',
            ...
            'secret' => 'a660403b89b91a69a1068d152bf4205a9dd8dcce',
            'locale' => 'en',
            ...
            'kernel.secret' => 'a660403b89b91a69a1068d152bf4205a9dd8dcce',
            ...
            'assetic.ruby.bin' => ($this->targetDirs[5].'/.rvm/rubies/ruby-2.2.1/bin/ruby'),
