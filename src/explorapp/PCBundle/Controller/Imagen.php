...
class Imagen
{
	...
	{
		$info = pathinfo($this->imagenDestino);
		$ImgTemporal= $info['dirname']."/temporal_clase_Imagen.".strtolower($this->extencion);
...
*/
/*
 * Si se envia a crear una imagen de mayor tama\F1o a la original.
 * El modo 0 simplemente regresa la imagen con el mismo tama\F1o.
 *  modo 1 lo mismo
